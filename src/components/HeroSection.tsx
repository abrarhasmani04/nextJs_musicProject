...
const HeroSection = () => {
  return (
    <div className='min-h-screen w-full rounded-md flex flex-col items-center justify-center relative mx-auto py-10'>
     <Spotlight
  className="-top-72 left-0 md:-top-96 md:left-60"
  fill="silver"
/>
